...
settings.competition_aliases = {
    ...
    '6_n': '6_nations',
    '6n': '6_nations',
    six_nations: '6_nations',
    'women\'s_6_nations': 'women\'s_6_nations',
    '6_nations_womens': 'women\'s_6_nations',
    womens_6_n: 'women\'s_6_nations',
    womens6n: 'women\'s_6_nations',
    women_six_nations: 'women\'s_6_nations',
    'women\'s6n': 'women\'s_6_nations',
    'women\'s_six_nations': 'women\'s_6_nations',
    trc_2020: 'trc_2020',
    trc: 'trc_2020',
    the_rugby_championship: 'trc_2020',
    rugby_europe: 'rugby_europe',
    rec: 'rugby_europe',
    pacific_nations_cup: 'pacific_nations_cup',
    pnc: 'pacific_nations_cup',
    u20_championship: 'u20_championship',
    u20: 'u20_championship',
    u20wc: 'u20_chamionship',
    u20s_wc: 'u20_chamionship',
    u20swc: 'u20_chamionship',
    'u20\'s_wc': 'u20_chamionship',
    'u20\'s_championship': 'u20_chamionship',
    international_friendlies: 'international_friendlies',
    friendly: 'international_friendlies',
    international: 'international_friendlies',
    internationals: 'international_friendlies',

    premiership_rugby: 'premiership_rugby',
    prem: 'premiership_rugby',
    premiership: 'premiership_rugby',
    english_prem: 'premiership_rugby',
    english_premiership: 'premiership_rugby',
    gallagher: 'premiership_rugby',
    proper_rugby: 'premiership_rugby',
    prem_rugby_cup: 'prem_rugby_cup',
    prc: 'prem_rugby_cup',
    prem_cup: 'prem_rugby_cup',
    premiership_rugby_cup: 'prem_rugby_cup',
    anglo_welsh: 'prem_rugby_cup',
    awc: 'prem_rugby_cup',
    ...
    europe: 'champions_cup',
    champs_cup: 'champions_cup',
    championscup: 'champions_cup',
    champ_cup: 'champions_cup',
    champscup: 'champions_cup',
    ...
    sr: 'super_rugby',
    nrc: 'nrc',
    national_rugby_championship: 'nrc',
    mitre_10_cup: 'mitre_10_cup',
    mitre_10: 'mitre_10_cup',
    m10c: 'mitre_10_cup',
    m_10_c: 'mitre_10_cup',
    mitre10: 'mitre_10_cup',
    currie_cup: 'currie_cup',
    currie: 'currie_cup',
    cc: 'currie_cup',
    'premier_15\'s': 'premier_15\'s',
    sr_aotearoa: 'sr_aotearoa',
    sr_nz: 'sr_aotearoa',
    givemesomedamnruggers: 'sr_aotearoa',
    shrugbybestrugby: 'sr_aotearoa',
    super_rugby_nz: 'sr_aotearoa',
    sr_new_zealand: 'sr_aotearoa',
    sr_australia: 'sr_australia',
    sr_au: 'sr_australia',
    sr_folau: 'sr_australia',
    super_rugby_au: 'sr_australia',
    super_rugby_aus: 'sr_australia',
    super_rugby_australia: 'sr_australia',
    sr_aus: 'sr_australia',

    //for competition tables (not checked UR name for these leagues)
    nat_1: 'english_nat_1',
    national_1: 'english_nat_1',
    nat1: 'english_nat_1',
    n1: 'english_nat_1',
    nat_2: 'english_nat_2',
    national_2: 'english_nat_2',
    nat2: 'english_nat_2',
    n2: 'english_nat_2',
};
...
settings.team_aliases = {
    ...
    glos: 'gloucester_rugby',
    glaws: 'gloucester_rugby',
    our_year: 'gloucester_rugby',
    tigers: 'leicester_tigers',
    leicester: 'leicester_tigers',
    irish: 'london_irish',
    london_australian: 'london_irish',
    exiles: 'london_irish',
    bath_b: 'london_irish',
    bath_a: 'london_irish',
    sale: 'sale_sharks',
    saints: 'northampton_saints',
    northampton: 'northampton_saints',
    sarries: 'saracens',
    cheaters: 'saracens',
    cheats: 'saracens',
    worcester: 'worcester_warriors',
    falcons: 'newcastle_falcons',
    newcastle: 'newcastle_falcons',
    yorkshire: 'yorkshire_carnegie',
    carnegie: 'yorkshire_carnegie',
    pirates: 'cornish_pirates',
    cornish: 'cornish_pirates',
    coventry: 'coventry_rugby',
    jersey: 'jersey_reds',
    doncaster: 'doncaster_knights',
    knights: 'doncaster_knights',
    ealing: 'ealing_trailfinders',
    trailfinders: 'ealing_trailfinders',
    nottingham: 'nottingham_rugby',
    scottish: 'london_scottish',
    welsh: 'london_welsh',
    hartpury: 'hartpury_college_rfc',
    hcrfc: 'hartpury_college_rfc',
    ampthill: 'ampthill_rugby',

    // France
    bordeaux: 'union_bordeaux_begles',
    begles: 'union_bordeaux_begles',
    bordeaux_begles: 'union_bordeaux_begles',
    union_bordeaux_bègles: 'union_bordeaux_begles',
    bordeaux_bègles: 'union_bordeaux_begles',
    clermont: 'clermont_auvergne',
    asm: 'clermont_auvergne',
    asm_clermont_auvergne: 'clermont_auvergne',
    lyon_olympique_universitaire: 'lyon',
    lou: 'lyon',
    aviron_bayonnais: 'bayonne',
    toulon: 'rc_toulon',
    rc_toulonnais: 'rc_toulon',
    castres: 'castres_olympique',
    section_paloise: 'pau',
    montpellier_rugby: 'montpellier',
    su_agen: 'agen',
    stade_rochelais: 'la_rochelle',
    rochelle: 'la_rochelle',
    stade_toulousain: 'toulouse',
    stade_français: 'stade_francais',
    stade_français_paris: 'stade_francais',
    stade_francais_paris: 'stade_francais',
    sf: 'stade_francais',
    racing: 'racing_92',
    r92: 'racing_92',
    r_92: 'racing_92',
    ca_brive: 'brive',
    club_athletique_brive: 'brive',

    // Scotland
    glasgow: 'glasgow_warriors',
    glesga: 'glasgow_warriors',
    ...
    diff: 'cardiff_blues',
    the_diff: 'cardiff_blues',

    // Italy
    treviso: 'benetton_rugby',
    benetton: 'benetton_rugby',
    benetton_treviso: 'benetton_rugby',
    zebre: 'zebre_rugby',
    ...
    evil: 'new_zealand',
    abs: 'new_zealand',
    all_blacks: 'new_zealand',
    kiwis: 'new_zealand',
    bad_guys: 'new_zealand',
    baddies: 'new_zealand',
    sa: 'south_africa',
    za: 'south_africa',
    bokke: 'south_africa',
    springboks: 'south_africa',
    aus: 'australia',
    wallabies: 'australia',
    convicts: 'australia',
    aussies: 'australia',
